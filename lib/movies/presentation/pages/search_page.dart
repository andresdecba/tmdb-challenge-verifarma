...
class SearchPageState extends ConsumerState<SearchPage> {
  ...
  void initState() {
    ...
    provider.keywordCtlr = TextEditingController();
    provider.fromYearCtlr = TextEditingController();
    provider.toYearCtlr = TextEditingController();
    provider.peopleCtlr = TextEditingController();
    provider.yearCtlr = TextEditingController();
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              TextFormField(
                controller: provider.peopleCtlr,
              ...
              Row(
                children: [
                  Flexible(
                    child: TextFormField(
                      controller: provider.fromYearCtlr,
                      keyboardType: TextInputType.number,
                      decoration: _inputDecoration(
                  ...
                  Flexible(
                    child: TextFormField(
                      controller: provider.toYearCtlr,
                      keyboardType: TextInputType.number,
                      decoration: _inputDecoration(
